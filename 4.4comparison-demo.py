...
result1 = (a > b)
print(f'a: {a} b: {b} den büyüktür: {result1}')
...
isEmail = (email == girilenEmail.lower().strip()) #eğer mail girilirken sonda bir boşluk bırakılırsa o silinsin diye .strip kullandık
